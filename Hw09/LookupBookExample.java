...
public class LookupBookExample{
	...
	if (runStudentSubmission) {
        // ppl who sit near me in class
        String[] students = {"Annabelle","Biruk","Crawford","Lola","Marci","Olivia","Rachel","Regan","Rocky","Yurii"};
        Integer[] studentIDs = {1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010};
        Node<String, Integer> studentLookupBook = new Node<>(students, studentIDs);
    
        // test
        System.out.println(studentLookupBook.find("Crawford"));
        System.out.println(studentLookupBook.find("Annabelle"));
        System.out.println(studentLookupBook.find("Yurii"));
    
        // Print the entire student lookup book
        System.out.println(studentLookupBook);
    }
